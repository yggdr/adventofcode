...
doubleletters=[i+i for i in lowercase]
pairs=[i+j for i in lowercase for j in lowercase]
...
with open('input') as input:
    ...
    lineswithreps=(line for line in lineswithpairs if search(r"([a-z])[a-z]\1", line))
